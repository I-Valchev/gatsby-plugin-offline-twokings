...
export const onPreRenderHTML = ({
  ...
  const filteredHeadComponents = headComponents.filter(({
    type,
    props
  }) => !(type === `link` && props.as === `fetch` && props.rel === `preload` && (props.href.startsWith(`/static/d/`) || props.href.startsWith(`/page-data/`))));
...
export const onRenderBody = ({
  ...
  setHeadComponents([/*#__PURE__*/React.createElement("noscript", {
